# John Gallagher
# July 16, 2026
# Script to denerate data of HMC-LF on - gen gauss. For some sizes of tau, there is numerical instability of LF scheme on the HMC problem leading to non convergence. 
...
plt.savefig(f'plots/avg_cov_max_diag_err_scaling_vs_kappa{κ_min}:{κ_max}_τ{tau_str}_oneplot2.png')
...
plt.savefig(f'plots/avg_cov_max_diag_err_scaling_vs_kappa{κ_min}:{κ_max}_τ{tau_str}_oneplot2_grid.png')
