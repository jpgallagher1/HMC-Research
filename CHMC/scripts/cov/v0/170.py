...
rho = gen_2D_perturb_vals(170)
target_mat = jnp.linalg.inv(gen_perturb_mat(2, rho))
...
true_cov_matrices = jnp.linalg.inv(target_mat)
...
plt.savefig(f'plots/cov_max_diag_err_scaling_vs_kappa{conds[0]}.png')