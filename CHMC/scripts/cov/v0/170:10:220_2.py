...
plt.savefig(f'plots/avg_cov_max_diag_err_scaling_vs_kappa{κ_min}:{κ_max}_oneplot2.png')
...
plt.savefig(f'plots/avg_cov_max_diag_err_scaling_vs_kappa{κ_min}:{κ_max}_oneplot2_grid.png')
