...
#
# possibly is replicating incorrect behaviour and does not have HMC converging at all or generating any data for the plot. 
...
plt.savefig('plots/verify/cov_prec_max_diag_err2d_kappa100_diverge.png')
print('plot saved')
# plt.show()
