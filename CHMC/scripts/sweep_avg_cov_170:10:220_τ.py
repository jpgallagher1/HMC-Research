...
figpath1 = f'plots/avg_cov_max_diag_err_scaling_vs_kappa{κ_min}:{κ_max}_τ{tau_str}_oneplot2.png'
...
figpath2 = f'plots/avg_cov_max_diag_err_scaling_vs_kappa{κ_min}:{κ_max}_τ{tau_str}_oneplot2_grid.png'
