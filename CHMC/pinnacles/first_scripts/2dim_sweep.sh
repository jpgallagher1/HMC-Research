...
#SBATCH --ntasks-per-node=2 # this job requests for 56 cores on a node
...
#SBATCH --job-name=2dim_cov_metric_kappa41-50_sweep   # this is your job’s name
#SBATCH --mail-user=johngallagher@ucmerced.edu  
#SBATCH --mail-type=ALL  #uncomment the first two lines if you want to receive     the email notifications
#SBATCH --export=ALL


python CHMC/scripts/plot_2dim_cov_metric_kappa_sweep.py